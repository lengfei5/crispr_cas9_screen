...
print(sys.argv[2]) # experiment index
print(sys.argv[3]) # ouptput
...
# two parameters to define barcode shadow (due to mutation in sequencing)
# minfold = 3.0 suggested by Georg  
maxMM = 1
minfold = 3.0
# minmum read counts (sum of all samples considered) for real UMI
minreads = 10.0
