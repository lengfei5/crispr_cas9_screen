...
for RAW in ${DIR_FC}/CB5LRANXX_7_20170825B_20170827.bam; 
do
    echo $RAW
    qsub -q public.q -o $DIR_cwd/logs -j yes -pe smp $nb_cores -cwd -b y -shell y -N demultiplex  "/groups/vbcf-ngs/bin/funcGen/jnomicss.sh illumina2BamSplit --inputFile $RAW --toFastq --dualBClength1 6 --dualBClength2 6 --correctdual standard --indexRead dual2"
done
cd $DIR_cwd